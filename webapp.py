...
st.sidebar.image('olympics-logo.jpg')
user_menu = st.sidebar.radio(
    "select an option",
    ('Medal Tally','Overall Analysis','Country Analysis','Athlete Wise Analysis')
)
...
if user_menu == 'Overall Analysis':
    ...
    Ahelit_over_time =  helper.data_over_time(df, 'Name')
    fig = px.line(Ahelit_over_time,x= 'Year', y='count')
    st.title("Athelits Over the years")
    st.plotly_chart(fig)
...
if user_menu == 'Athlete Wise Analysis':
    ...
    ax = sns.scatterplot(x=temp_df['Weight'], y=temp_df['Height'], 
                         hue=temp_df['Medal'],style=temp_df['Sex'],s=50)
